CREATE TABLE cliente(
    ...
    data_adesao DATE DEFAULTS(SYSDATE) NOT NULL ,
    ...
    CONSTRAINT pk_cliente PRIMARY KEY (key),  -- Defines the primary key for the cliente (client) table
    ...
    CONSTRAINT ck_cliente_nome CHECK (REGEX_LIKE(nome, '^[A-Z]')), -- Validates that the client name begins with a capital letter
